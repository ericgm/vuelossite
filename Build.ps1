...
$projectFilePath = join-path $current "\Vuelos\Vuelos.csproj"
...
& $nunit "./Vuelos.UnitTest/Vuelos.UnitTest.csproj"

#TransFormXmlConfigFiles $projectFilePath  $package_config_path

Copy-Item Vuelos.nuspec -Destination .\Build\app.nuspec

Copy-Item .\Packaging\Tools\* -Destination .\Build\tools\ -Recurse
